...
<head>
    ...
    <link rel="stylesheet" href="style_poster.css?v=10016">
...
<body class="poster-body">
    <main class="poster-container">
        ...
        <h2 class="cta-title">DAFTAR<br>SEKARANG!</h2>
        <a href="form_individu.php" class="register-btn-large">KLIK DI SINI UNTUK MENDAFTAR</a>
