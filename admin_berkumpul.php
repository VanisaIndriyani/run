                            ...
                            <?php if ($result->num_rows > 0): ?>
                                ...
                                <tr>
                                    ...
                                    <td style="white-space: nowrap;">
                                        <a href="view_peserta.php?id=<?php echo $row['id']; ?>&source=group" class="btn-sm" style="background: #17a2b8;" title="Lihat"><i class="fas fa-eye"></i></a>
                                        <a href="edit_peserta.php?id=<?php echo $row['id']; ?>&source=group" class="btn-sm" style="background: #ffc107; color: #000;" title="Edit"><i class="fas fa-edit"></i></a>
                                        <a href="print_receipt.php?id=<?php echo $row['id']; ?>&source=group" target="_blank" class="btn-sm" title="Cetak Resit"><i class="fas fa-file-pdf"></i></a>
                                    </td>
                                </tr>
                                <?php endwhile; ?>
                            <?php else: ?>
